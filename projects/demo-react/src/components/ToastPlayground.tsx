        ...
        <div className="code-preview-section">
          ...
          <div className="code-block-wrapper">
            ...
            <pre className="language-typescript">
              <code className="language-typescript" dangerouslySetInnerHTML={{ __html: highlightedTs }}></code>
            </pre>
          </div>
          ...
          <div className="code-block-wrapper">
            ...
            <pre className="language-markup">
              <code className="language-markup" dangerouslySetInnerHTML={{ __html: highlightedHtml }}></code>
            </pre>
          </div>
        </div>
      </div>
